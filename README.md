...
- **Model Development**: Implements regression models (Linear Regression, Random Forest, XGBoost).  
- **Performance Metrics**: Evaluates models using RMSE, MAE, and R² scores.  
- **Scalability**: Designed for larger datasets and real‑time prediction pipelines.  
...
4. **Model Training** → Fit ML models & tune hyperparameters  
5. **Evaluation** → Compare models & select best performer  
6. **Deployment Ready** → Code structured for integration into production pipelines  
